import tabix       # multiprocessing doesn't work for this piece of code
import pandas as pd
...
input_pixel_file = '/Users/jiangxu/Documents/higlass_data/CTCC_SDS_HindIII/hg38/block0_1.tmp'
...
n = 100000
split_data = [df[i:i+n] for i in range(0, 200000, n)]
...
with concurrent.futures.ProcessPoolExecutor() as executor:
    for data in split_data:
        result = executor.submit(add_bins, data)
...
print(f'single processing used {(end-start)} seconds')
