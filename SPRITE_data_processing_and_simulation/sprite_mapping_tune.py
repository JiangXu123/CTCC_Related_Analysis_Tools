...
def run(args):
    ...
    while i < len(df):
        ...
        read_name_2 = df.iloc[i, 0][1:].split(" ")[0]  # get the read name off the @ at the beginning
        ...
        print(f'read {i+1} name_1 is {read_name_1}')
        print(f'read {i+1} name_2 is {read_name_2}')
        i += 1
