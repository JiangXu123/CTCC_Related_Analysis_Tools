...
### This code is to correct the name problem of the NGS sequencing data generated from sratools from the nih
### where PE sequencing data Read1.fastq and Read2.fastq have different names
def run(args):
